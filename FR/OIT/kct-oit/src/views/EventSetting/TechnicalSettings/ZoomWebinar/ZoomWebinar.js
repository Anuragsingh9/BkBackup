 ...
 *
 * ---------------------------------------------------------------------------------------------------------------------
 * @description This child component is for displaying data of Zoom webinar details like maximum participants , number
 *  of licenses , assigned or not and is locked and these licenses can be use in Zoom webinar.
 * ---------------------------------------------------------------------------------------------------------------------
 *
 * @param {Object} props Props  passed from parent component
...
const ZoomWebinar = (props) => {
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------
     * @description This method is used to get Zoom webinar accounts data by using getKeyData that calls API if
    ...
    const getData = () => {
        ...
        var data = props.getKeyData('zoom_webinar_settings')
        setWebinarData({
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------
     * @description This method is used tp get numbers of licenses and updates state
     * -----------------------------------------------------------------------------------------------------------------
     *
     * @method
        ...
        <>
            <>
                ...
                <Grid container xs={12}>
                    ...
                    <HandleBox getNO={(v) => getNo(v)} getId={(id) => getId(id)} deleteItem={handleRemoveLicense}
                               license={webinarData.number_of_licenses} licenseData={webinarData.license} />
                    }
                </Grid>
                }
            </>
