...
.secondry-border-transparency1{
    border-color: {{$transprancy7}} !important;
}
.parimary-border-transparency1{
    border-color: {{$transprancy1}} !important;
}
.secondry-border-transparency2{
    border-color: {{$transprancy2}} !important;
}
.light-font{
font-weight: 300;
}
...
.nav-tabs>li.active>a, .nav-tabs>li.active>a:hover, .nav-tabs>li.active>a:focus,.tab-menu>li.current-menu-item>a, .nav-tabs>li>a:hover, .nav-tabs>li>a:focus {
color: #fff;
...
.meeting-timedetail .date-view i:last-child {
    font-size: 23px;
}
...
.doodle-meeting-form .text-field-label {
    margin-bottom: 5px;
}
...
.picUpload_parent avatar-image.picUpload_div>div:not(:first-child)>div {
...
.popsonresize .modal-dialog{
width: 400px;
}
.popsonresize .modal-body p{
word-break: normal;
}
...
.drag-dots-icon svg path{
fill: #fff;
}
.drop-style1 .dropdown-toggle:has( span){
padding-left: 30px;
}
.border-top-light {
border-top: 1px solid #e1e1e1;
...
.cardDelEdit button.removeBtn, .cardDelEdit button.editBtnSvg {
float: left;
}
.IconButton__isActive___2Ey8p {
background: transparent !important;
}
.card-info-tabs .ButtonGroup__root___3lEAn {
...
.status-change-block, .assign-change-block{
...
/*.custom-select .Select-control .Select-input {
height: 40px;
}
.custom-select .Select-control .Select-input > input {
padding: 8px 0px;
line-height: 24px;
}
...
.card-info-tabs .form-control {
height: 36px;
}
.input-group-btn button.pb-button {
border-radius: 0px 3px 3px 0px;
}
.default-form-style.task-doc {
background-color: #f3f3f3;
padding: 10px;
}
.comment-box-inner .cke_contents {
...
.circle-report .CircularProgressbar .CircularProgressbar-trail {
stroke: #e7e6e5;
}
.circle-report .CircularProgressbar .CircularProgressbar-path {
stroke: {{$color2}};
}
.circle-report {
margin: 0 auto;
...
.orangeProject .__inner{
border: 2px solid #faa643;
}
.greenProject .__inner{
border: 2px solid #7fd86f;
}
...
.taskDueCalendar .__inner .project-due-details{
float: left;
}
...
.taskDueCalendar .__inner::before{
left: 10px;
}
.taskDueCalendar .__inner::after{
right: 10px;
}
.redProject .__inner::before, .redProject .__inner::after{
background-color: #fa4643;
}
.orangeProject .__inner::before, .orangeProject .__inner::after{
background-color: #faa643;
}
.greenProject .__inner::before, .greenProject .__inner::after{
background-color: #7fd86f;
}
.sideTaskPanelInner .slide-pane__title-wrapper {
margin-right: 30px;
}
.sideTaskPanelInner .slide-pane .slide-pane__title{
max-width: 100%;
}
.taskNameField span {
width: 100%;
...
.redProject .taskDueHead{
background: #fa4643;
color: #fff;
}
.orangeProject .taskDueHead{
background: #faa643;
color: #fff;
}
.greenProject .taskDueHead{
background: #7fd86f;
color: #fff;
}
.taskDueHead{
...
.threeColTable .table-div-body .rc-draggable-list-draggableRow:not(:last-child){
border-bottom: 1px solid #cccccc;
}
.threeColTable .table-div-body .third-part{
display: inherit;
...
.statusAssignBtns .svgicon svg path {
...
.userImgUploadBox .picUpload_parent avatar-image.picUpload_div > div:first-child div:first-child p{
...
.input-group-btn .pb-container .pb-button{
padding: 5px;
}
.picUpload_parent avatar-image.picUpload_div>div:first-child div:first-child p {
font-size: 14px !important;
...
.imgUploadeStyle1 .picUpload_parent avatar-image.picUpload_div>div:not(:first-child)>div>div>div {
background: #fff !important;
}
.imgUploadeStyle1 a.imgCropUploadClose, .imgUploadeStyle1 a.imgCropUploadDone {
color: #fff;
}
...
.task-filter-body .mCSB_inside>.mCSB_container {
margin-right: 15px;
}
.heading-txt{
font-size: 14px;
...
.mileston-content-outer .DayPicker-Day {
font-size: 12px;
}
#addTabModal .modal-dialog {
width: 450px;
}
...
.drop-style1.dropdown a.site-color.no-style{
word-break: break-word;
}
.repdAgenda_topic.all-agenda-topics li span.cke_reset {
width: 100%;
}
...
.dashboard-commission .inline-form-sec.site-bg-color2{
background: #fff !important;
}
...
.select-cover .DayPickerInput .DayPickerInput-OverlayWrapper{
z-index: 1;
}
...
.css-1vm9g5e, [data-css-1vm9g5e]{
height: 50px;
}
.login-pass input::-ms-expand{
display: none;
}
input::-ms-clear,
input::-ms-reveal,
...
.chat-form .Select-control .Select-arrow-zone{
display: none;
}
.start_col .panel{
margin-bottom: 15px;
}
.meeting-timedetail .date-view label {
cursor: pointer;
}
...
.agenda_list_li .search-commission-outer .site-bg-color2 {
background: #fff;
}
.agenda_list_li .search-commission-outer .container.dsearch-form {
padding: 0px !important;
}
...
.next-meeting-div .linkBtn span.linkBtn-icon i {
padding: 0px 5px;
}
.border-top-none{
border-top: none !important;
...
.lable-icon-pb svg path{
fill: #9d9d9d;
}
.lable-icon-pb.active svg path{
fill: {{$color2}};
}
.lable-icon-pb.blue svg path{
fill: #4F71D0;
}
.icon-20 svg{
width: 20px;
...
.notes-wrapper-left, .notes-wrapper-right {
padding: 10px 15px;
}
.notes-boxdiv .left-box span.drag-dots-icon {
margin: 5px;
}
.notes-boxdiv .left-box svg path {
fill: {{$color2}};
}
...
.notes-boxdiv .right-box .note-datetime {
text-align: right;
}
.note-control-header {
width: 100%;
...
.tab-menu-section ul.nav.nav-pills {
border-bottom: 1px solid #f1f1f1;
}
...
.custom-scroll-menu li span {
cursor: pointer;
}
.custom-scroll-menu li span.svgicon {
padding: 5px 10px;
}
.custom-scroll-menu li span.svgicon svg{
width: 22px;
height: 22px;
}
...
.custom-scroll-menu li span.svgicon svg path {
fill: #444 !important;
}
...
.custom-scroll-menu li span.svgicon.active svg path{
fill: {{$color2}} !important;
}
.no-req-label::after{
content: '';
...
span.or-separate:before{
left: 0;
}
span.or-separate:after{
right: 0;
}
...
.notes-boxdiv .right-box .note-datetime span.time {
vertical-align: inherit;
}
.DayPicker .DayPicker-Day {
padding: 5px !important;
}
.task-list .table>tbody>tr:first-child>td {
border-top: none;
}
.trainee-view {
margin-right: 10px;
...
.table-default-icon tr td .svgicon svg path {
fill: #888888;
}
.table-default-icon tr td .svgicon.active svg path {
fill: {{$color2}};
}
...
.div-tbody-tr:hover .div-table-col.div-td span.td-drag-icon{
display: block;
}
.div-td.drag-icon-field {
padding-left: 20px;
}
...
.selected-options-list a.list-group-item {
...
.selected-options-list .rc-draggable-list-draggableRow:not(first-child) {
margin-top: 2px;
}
.full-label{
width: 100%;
...
.custom-checkbox input[type="checkbox"] + .custom-check-span{
cursor: pointer;
}
...
.mandatoryBox .input-group .form-control {
background-color: #fff;
}
.mandatoryBox .form-group label {
color: #333;
}
...
.skill-inputfield button{
height: 34px;
}
.input-group-btn>.btn{
z-index: 2;
}
.skill-inputfield span.input-group-btn {
padding-left: 10px;
}
...
.skill-tab-select .select-cover select {
max-width: 100%;
}
...
select.default-selectbox:focus {
outline: none;
}
...
.custom-responsive-table .react-bs-table{
overflow: auto;
}
/*.custom-responsive-table .react-bs-table table {
margin-bottom: 0;
...
.custom-responsive-table .react-bs-table table td, .custom-responsive-table .react-bs-table table th {
width: 180px;
}*/
...
.custom-responsive-table .react-bs-table table td .rc-slider-disabled{
background: transparent;
}
...
.mandatoryBox span.mandatorySvgIcon svg path{
fill: #fff !important;
}
.div-tbody li {
display: block;
...
.skill-table-textarea button.btn, .skill-inputfield button.btn, .skilltab-percentage button.btn {
min-width: inherit;
}
...
.table-data-shorting .form-group{
margin-bottom: 12px;
}
...
background-color: {{$transprancy7}} !important;
}
.progress-bar-success {
background-color: #3c763d !important;
}
.btn-wrap-h40 button.pb-button, .btn-h40 {
height: 40px;
}
.border-rright-none{
...
.meeting-report-table button.btn {
min-width: inherit;
}
/* End OPS Migration CSS */

.drop-style1 ul.dropdown-menu li a {
white-space: normal;
}
.customize-label-fields .help .svgicon {
margin-left: 10px;
}
...
.dynamicSkill-blockdata .skill-inputfield input {
height: 36px;
}
...
span.pointer.rotate-icon.onrotate-icon.disable {
cursor: none;
}
...
/*.customSkillField-blockdata input.form-control {
height: 36px;
}*/
...
.map-control-btns a.edit-map img {
width: 24px;
}
.file-icon{
min-height: 35px;
...
@media (min-width: 768px){
.scrollmodal-headbody .modal-content {
max-height: 90vh;
}
...
.task-list.autocomplete-form .divLeft_space35 {
position: relative !important;
}
...
.custom-responsive-table .rc-slider-mark {
top: 14px;
}
.all-agenda-topics.repdAgenda_topic>li.repd-li .show-add span {
margin-right: 6px;
}
.staff-login-form button[type="submit"].btn-primary {
white-space: normal;
}
.topic-project .milestone-title-inner {
background-color: #f7f7f7;
}
...
.mandatoryBox span.mandatory_acceptance_icon svg path.fillColor2 {
fill: {{$transprancy2}} !important;
}
.mandatoryBox span.mandatory_acceptance_icon svg path.fillColor3 {
...
.topic-project .DayPicker-Caption > div {
font-size: 14px;
}
.workshop-choose-field select {
height: 30px;
}
.workshop-choose-field .form-group {
margin-bottom: 11px;
}
.label-list-group {
width: 33%;
...
.next-meeting-div .dropdown.btn-inline {
width: 45%;
}
...
.colorPickerBlock > div + div {
z-index: 3 !important;
}
.mandatory-child-block{
min-height: 135px;
}
...
.custom-responsive-table table thead tr td, .custom-responsive-table table tbody tr td {
min-width: 180px;
}
.daycal-time .cal-time-block select.form-control {
width: 100px;
}
.modal-backdrop.in {
position: fixed;
...
.table>tbody>tr>td a.btn.btn-primary {
color: #fff !important;
}
...
.btn-secondary,
button.btn-primary.gray {
background: gray !important;
border-color: gray !important;
}
.default-form .form-group.col-xs-12.col-md-6:nth-child(2n+1) {
clear: left;
}
.xl-btn{
min-width: 220px;
...
.radio-btn, .radio-btn span, .radio-btn input{
cursor: pointer;
}
...
.panel-style-default table tr td svg {
width: 20px;
}
...
.card-info-tabs textarea.form-control{
height: 75px;
}
.skill-table-textarea input.form-control {
height: 34px;
}
.fa-eye.icon::before {
font-weight: 400;
...
button.edit-pencil-btn i.fa { font-size: 12px; }
.input-group span.input-group-btn { vertical-align: top; }
...
.setting-opt-menu .Select-control{ height: 30px; }
...
.user-status-sign.offline{ border-color: #ccc; }
.msg-user-name {
    color: #9c9c9c;
    cursor: pointer;
}
...
/***************/
.txt-btn-group .form-control {
    padding: 10px 10px;
}
.dropdown-menu li a {
    cursor: pointer;
}
.msg-topic ul li:hover {
    background: #f6f6f6;
}
.input-group-btn{
    vertical-align: top;
...
span.react-dropdown-select-item.disableClass {
    color: #c7c7c7;
}
...
.react-dropdown-select-dropdown span.react-dropdown-select-item:hover{
    background-color: #f7f7f7;
}
...
.horizontal-icons-menu li span svg{
    vertical-align: baseline;
}
.svg-gray svg path, .svg-gray svg circle, .svg-gray svg polygon{
    fill: lightgray !important;
}
.svg-gray.active svg path, .svg-gray.active svg circle, .svg-gray.active svg polygon{
...
.__react_component_tooltip.disable-tooltip.type-dark {
    background-color: #e5e5e5 !important;
}
.__react_component_tooltip.disable-tooltip.type-dark.place-top:after {
    border-top-color: #e5e5e5 !important;
}
.__react_component_tooltip.disable-tooltip.type-dark.place-bottom:after {
    border-bottom-color: #e5e5e5 !important;
}
.__react_component_tooltip.disable-tooltip.type-dark.place-left:after {
    border-left-color: #e5e5e5 !important;
}
.__react_component_tooltip.disable-tooltip.type-dark.place-right:after {
    border-right-color: #e5e5e5 !important;
}
/**********************/
.listing-open .repd-list-head {
    color: {{$color2}};
}
.react-bs-table-pagination .row {
    margin-top: 0 !important;
...
.green.meeting-three-dot svg path {
    fill: #00af5f !important;
}
.svg-white path{
...
.th-inner-with-icon.vid-meet-th {
    padding-right: 45px;
}
.react-bs-table .react-bs-container-header>table>thead>tr>th .th-inner-with-icon.vid-meet-th + span.order{
    right: 25px;
}
