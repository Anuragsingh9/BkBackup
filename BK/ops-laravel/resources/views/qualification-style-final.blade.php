...
.regis-step-list .rc-draggable-list{
    width: 100%;
    float: left;
}
...
.regis-step-list .registration-step.step-w-btns {
    padding-right: 50px;
}
.regis-step-list .registration-step span.step-count {
    background: #b7b7b7;
}
.regis-step-list .registration-step.active{
    color: {{$color2}};
}
.regis-step-list .registration-step.active span.step-count {
    background: {{$color2}};
}
...
.regis-step-list .registration-step:hover .step-controller{
    display: block;
}
...
.step-fields-w-label .step-content-field .input-value {
    margin-top: 10px;
    min-height: 32px;
}
.step-fields-w-label .step-content-field {
    padding-right: 100px;
    padding-left: 30px;
}
.btn-lg {
...
.step-description .input-group.select-w-btn {
    max-width: 320px;
}
...
.qualification-header button.dropdown-toggle {
    color: #fff;
    width: 100%;
}
.left-dropdowm-menu{
...
.left-dropdowm-menu .dropdown.drop-style1 {
    padding: 5px 10px;
}
.left-dropdowm-menu .dropdown {
    width: 150px;
}
...
.panel-group .panel-review-style + .panel-review-style {
    /*margin: 3px 0px;*/
}
.panel-group .panel-review-style + .panel-review-style .panel-body {
    min-height: 100px;
}
.panel-group .panel-review-style:last-child{
    /*border-bottom-width: 1px;*/
}
.panel-review-style {
    border-color: {{$color2}} !important;
}
.panel-review-style .panel-heading .accordion-toggle:after{
    color: {{$transprancy7}};
}
...
.color-opt-radio.rdo-red input[type="radio"]:checked + label{
    border-color: #e0001b;
}
...
.color-opt-radio.rdo-orange input[type="radio"]:checked + label{
    border-color: #f07f0a;
}
...
.color-opt-radio.rdo-green input[type="radio"]:checked + label{
    border-color: #80bd26;
}
.color-opt-radio.rdo-green input[type="radio"]:checked + label span.rdo-color{
    opacity: 1;
    filter: alpha(opacity=100);
    background-color: #80bd26;
}
.color-ops-rdo .radio-icons-group {
    display: inline-block;
}
.panelStyle .panel-heading .detail-header-accordion .accordion-toggle:after {
...
.detail-header-accordion:hover .color-ops-rdo{
    visibility: visible;
}
.accroding-btn-box{
    float: left;
...
.quali-row-opt-item > div {
    vertical-align: middle;
}
.tab-accordion-block .accordion-tab-left-header {
    width: 45%;
    float: left;
}
...
.tab-accordion-block .accordion-tab-menu nav{
    width: 100%;
    float: left;
}
...
.accordion-tab-menu .nav-tabs>li {
    width: 14.28%;
    flex: none;
}
...
.accordion-tab-menu .nav-tabs>li>a span {
    display: inline-block;
    margin: auto;
}
.accordion-tab-left-header h4 {
    color: {{$color2}};
    margin: 5px 0px 5px 0px;
}
.accordion-tab-left-header h4 span {
    font-size: 14px;
    margin-left: 10px;
}
.check-group-block,
.vote-review-icons-block {
    width: 50%;
    float: left;
}
...
.check-group-block .switch-box .switch {
    margin-right: 0;
}
...
.votereview-icon .horizontal-dots.red{
    color: #e64156;
}
.qualification-header-right {
    padding-left: 15px;
}
.qualification-header .navbar-nav>li>a {
    padding: 6px 15px;
    color: #fff;
}
.qualification-header .navbar-nav>li>a:hover {
    background: {{$color2}};
}
.btn-link:focus {
...
.step-content-field .customSkillField-blockdata > div .input-group {
    width: 100%;
}
.step-form-btns button:not(:last-child){
    margin-right: 10px;
}
.step-form-btns .d-inline > div {
    float: left;
}
.step-form-btns .d-inline > button {
    border-radius: 4px;
    margin-left: 10px;
}
.step-detail {
...
.step-fields-w-label .step-content-field .transparent-btn svg {
    width: 20px;
    height: 20px;
}
.step-content-field .drag-icon-candidate {
    top: 2px;
    height: 20px;
    left: 10px;
}
.regis-step-list .registration-step .drag-icon-candidate{
    width: 5px;
}
.panel.panel-review-style {
    border-radius: 0px;
}
.panel-review-style > .panel-heading {
...
.accordion-toggle.collapsed ~ .qual-decision-data-outer .qual-decision-data {
    display: none;
}
.qual-exp-data {
    width: 100%;
...
.memb-reply:not(:last-child){
    border-bottom: 2px dashed {{$transprancy7}};
}
...
.qual-decision-data form button,
.qual-decision-data form button:hover,
.qual-decision-data form button:focus,
.qual-memb-submit-btn:hover,
.qual-memb-submit-btn:focus {
    color: #fff;
}
.icon-checkbox {
    display: inline-block;
...
.icon-checkbox input[type="checkbox"]:checked + .icon-check-span i{
    display: block
}
.icon-checkbox.right input[type="checkbox"]:checked + .icon-check-span{
    border-color: #80bd26;
    color: #80bd26;
}
...
.qual-comp-list span.icon svg path{
    fill: {{$color2}};
}
.border-radius-0{
    border-radius: 0px !important;
}
.quali-row-opt-item span.svgicon path {
    fill: gray;
}
...
.current-qual-memb button.prev-btn{
    left: 0;
}
.current-qual-memb button.next-btn{
    right: 0;
}
...
.experts-rev-group .place-top .qual-exp-data.center-pop::after{

}
.experts-rev-group .__react_component_tooltip.place-bottom:after,
.experts-rev-group .__react_component_tooltip.place-top:after{
    display: none;
}
.experts-rev-group .__react_component_tooltip.place-top .qual-exp-data.center-pop::before{
    top: inherit;
    bottom: -26px
}
.experts-rev-group .__react_component_tooltip.place-top .qual-exp-data.center-pop::after {
    top: inherit;
    bottom: -21px;
}
.expert-rev-data-pop{
...
/*.pdf-view-popup .modal-content, .pdf-view-popup .modal-body {
    height: 100%;
}*/
...
.pdf-view-popup .modal-body .popimg{
    /*display: block;
...
.qual-validation-inner .lable-box .icon::before {
    color: gray !important;
}
.qual-validation-inner .lable-box .icon.active::before {
...
.step-data .crm-lfields-personalinfo .customSkillField-blockdata .text-left a {
    color: {{$color2}};
}
.step-fields-w-label .rc-draggable-list-draggableRow {
    display: inline-block;
    width: 100%;
}
.uploadfile {
...
.form-control-sm + span.input-group-btn button {
    height: 32px;
    padding: 5px 10px;
}
.nouploaded svg path {
...
.radio-group label.radio-inline:not(:last-child) {
    margin-right: 20px;
}
...
.quali-row-opt-item .lable-box,
.quali-row-opt-item .lable-box span {
    word-break: break-word !important;
}
.quali-row-opt-item .circle-icon-check{
	margin-top: 6px;
}
.quali-row-opt-item .lable-box span img {
    margin-left: 5px;
}
.qual-decision-data form button{
    display: block;
...
.field-label-icon-txt {
   /*max-width: 150px;*/
    width: 100%;
}
.div-table-col.div-td .txt-info-icon {
    vertical-align: middle;
    /*display: table-cell;*/
    display: inline-block;
    position: relative;
...
.div-table-col.div-td .txt-info-icon span {
    display: inline-block;
}
.txt-info-icon-inner {
    display: inline-block;
...
.field-label-icon-txt .txt-info-icon {
    position: relative;
    /*padding-right: 22px;*/
}
...
.double-border-line{
    width: 100%;
    border-top: 14px solid {{$color1}};
    border-bottom: 14px solid {{$color2}};
}
/***********/

.color-opt-radio.rdo-red.gray-btn input[type="radio"]:checked + label,
.color-opt-radio.rdo-green.gray-btn input[type="radio"]:checked + label{
    border-color: #888888;
}
.color-opt-radio.rdo-red.gray-btn input[type="radio"]:checked + label span.rdo-color,
.color-opt-radio.rdo-green.gray-btn input[type="radio"]:checked + label span.rdo-color {
    background-color: #888888;
}
.fa-question-circle:before {
    color: #585858;
}
.quali-row-opt-item .lable-box.field-label-icon-txt {
    width: 55%;
    max-width: 55%;
}
.dynamicSkill-blockname .txt-info-icon-inner img {
    top: 1px;
}
.heading-b-border{
    border-bottom: 1px solid {{$color2}};
...
span.fa.fa-eye.icon.ref-data-eye {
    width: 42px;
    text-align: left;
}
span.fa.fa-eye.icon.ref-data-eye::before {
    position: relative;
}
...
.reg-cer-req-wrap span.custom-check-span {
    padding: 0;
}
.certification-req-list {
    margin-bottom: 20px;
}

.skill-table-textarea .autocomplete-dropdown-container{
    border: 1px solid #e9e9e9;
}
/*.skill-table-textarea .autocomplete-dropdown-container .suggestion-item,
.skill-table-textarea .autocomplete-dropdown-container .suggestion-item:hover,
.skill-table-textarea .autocomplete-dropdown-container .suggestion-item--active {
    width: 100%;
...
.referrer-form .edit-map-btn {
    width: 30px;
    right: 16px;
    top: 0px;
}
.reg-cer-req-wrap span p {
    margin-bottom: 0;
}
.btn-min-200{
    min-width: 200px;
...
.panel-style-default.gray-panel >.panel-heading a.accordion-toggle {
    color: gray !important;
    border-bottom-color: gray !important;
}
.panel-style-default.gray-panel .panel-heading .accordion-toggle:after{
    background: gray !important;
}
.no-background{
    background: none !important;
}
.qualifelec-banner-img{
    width: 60%;
    float: left;
}
.qualifelec-banner-img img {
    float: right;
    max-width: 300px;
    margin-top: 0px;
    max-height: 300px;
}
.no-background .welcome-user {
    margin-top: 50px;
}
...
.registration-form-steps .step-content-field .customSkillField-blockdata {
    width: 70%;
}
