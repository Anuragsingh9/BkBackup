...
dateConvert($mail['meeting_data']->date.' '.$mail['meeting_data']->start_time,' h\hi'),
...
@endphp
		<tbody>
			...
			<tr><td><a href="{{$mail['url_repd']}}">Consultez le relevé de décisions </a></td></tr>
			<tr><td>
			<a href="{{$mail['url_task']}}">Accédez à vos tâches</a></td></tr>
