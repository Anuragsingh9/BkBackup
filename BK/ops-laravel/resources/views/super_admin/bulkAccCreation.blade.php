        ...
        <main class="main">
            ...
            <div class="container page-content">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="site-color mt-20 mb-30"><strong>Instant Account Creation</strong></h4>
                            <h5>Enter the basics data for each account creation :</h5>
                            <br/>
                        </div>
                    </div>
                    ...
                    {{-- Form Heading Row --}}
                    <div class="row">
                        <div class="col-xs-2"><p>Org Admin First Name</p></div>
                        <div class="col-xs-2"><p>Org Admin Last Name</p></div>
                        <div class="col-xs-2"><p>Org Admin Email</p></div>
                        <div class="col-xs-2"><p>Organisation Name</p></div>
                        <div class="col-xs-2"><p>Account Name</p></div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            const appendFormHtmlTags = function (formId, formParentDivId) {
                // reusable string
                const inputDiv = '<div class="form-group col-xs-2">';
                ...
                $(`#${formParentDivId}`).append(`<form method="post" name="myForm" id="${formId}" class="form-inline">`);
                ...
                formSelector.append(`<div class="form-group col-xs-2" id="${"createBtnDiv" + currentFormCount}"><input type="submit" id="${"formSubmit" + currentFormCount}" class="btn-primary" style="border-style: solid" value="Create"></div>`);
                formSelector.append(`<div class="form-group col-xs-2" id="${"accountLinkDiv" + currentFormCount}" style="display:none"><a href="https://google.com" id="${"accountLink" + currentFormCount}">Link</div>`);
            }
