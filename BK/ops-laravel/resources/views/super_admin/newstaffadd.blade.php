        ...
        <div class="container page-content">
            <div class="col-xs-12 col-sm-12">
                <h4 class="site-color mt-20 mb-30">
                    <strong>{{(isset($user)? 'Edit Support Staff' : 'Add new Support Staff')}}</strong>
                </h4> 
            </div>
            {{ Form::open(array('url'=>route('savesuperstaff'),'class'=>"superadmin-form",'id'=>'superadmin-form')) }}
            <div class="col-xs-12">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group required-field {{ $errors->has('password') ? ' has-error' : '' }}">
                        <label class="col-xs-12 col-md-12 nopadding" for="">Votre Mot de passe</label>
                        <div class="clearfix">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group required-field {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        <label class="col-xs-12 col-md-12 nopadding" for=""> Mot de passe (Confirmation)</label>
                        <div class="clearfix">
