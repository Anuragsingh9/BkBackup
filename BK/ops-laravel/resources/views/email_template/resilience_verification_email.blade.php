...
isset($mail['consultation'])?$mail['consultation']:'',
 ...
 isset($mail['CommiteeSecLastName'])?$mail['CommiteeSecLastName']:'',
  isset($mail['CommiteeSecEmail']) ? $mail['CommiteeSecEmail'] : '',
...
isset($mail['WorkshopName'])?$mail['WorkshopName']:'',
isset($mail['WorkshopSecFirstName'])?$mail['WorkshopSecFirstName']:'',
isset($mail['WorkshopSecLastName'])?$mail['WorkshopSecLastName']:'',
];
     if(isset($mail['token'])){
