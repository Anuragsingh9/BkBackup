...
.picUpload_parent avatar-image.picUpload_div>div:not(:first-child) div[name="action-con"] {
min-width: 50px !important;
margin-left: 10px;
}
...
#screenResize .modal-body {
    text-align: center;
    font-size: 18px;
    color: #444;
}
#screenResize .modal-dialog{
	width: 400px;
}
#screenResize .modal-body p{
	word-break: normal;
}
#screenResize .modal-body svg{
	width: 50px;
	height: 50px;
}
.table-caption{
...
.slide-pane__close {
    background: url(../../work/ops_laravel/public/img/close-icon.png) no-repeat !important;
...
.close-icon {
    background: url(../../work/ops_laravel/public/img/close-icon.png) no-repeat;
    height: 12px;
    width: 12px;
    display: block;
...
.ReactModal__Content {
    ...
    -moz-transform: scale(1) rotateX(0deg) !important;
    -ms-transform: scale(1) rotateX(0deg) !important;
    -o-transform: scale(1) rotateX(0deg) !important;
