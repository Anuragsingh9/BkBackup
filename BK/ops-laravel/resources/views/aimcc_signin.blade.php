        ...
        <div class="app-body">
            <main class="main">
                @if(session()->has('error'))
                    <div class="alert alert-warning alert-dismissible error-panel" role="alert">
                ...
                <div class="container page-content">
                    ...
                    {{ Form::open(array('url'=>route('aimcc-signin-process'),'class'=>'login-form text-center white-text'))}}
                       {{ csrf_field() }}
                            ...
                            <div class="forgot-pass">
                               <a aria-current="false" class="white-text" href="{{ route('aimcc-forgot-password') }}">
                                Mot de passe oublié
                                </a>
