...
class VirtualEventV2Rule implements Rule {
    ...
    public function passes($attribute, $value) {
        ...
        if ($event && isset($event->bluejeans_settings['event_uses_bluejeans_event'])) {
            if ($event->bluejeans_settings['event_uses_bluejeans_event'] != 0) {
                $this->msg = __('cocktail::message.event_must_not_bj');
                return false;
            }
        }
        return true;
