...
class NewsService extends Service {
    ...
    public function getNewsByStatus($status) { // get all news of a given status
        if ($status == 'validated') {
            ...
            return News::with('newsLetterSentOn', 'reviewsCountByvisible', 'validatedOn')
    ...
    public function uploadNewsMedia($param) { // upload media according to media_type
        ...
        if (isset($param['request_media_type'])) {
            ...
            } else if ($param['request_media_type'] == Config::get('nl_const.news_media_image')) { // image from system uploading
