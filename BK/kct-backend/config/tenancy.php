...
use App\Generator\TenantDBNameGenerator;
...
return [
    ...
    'website'    => [
         ...
         */
        'random-id-generator'          => TenantDBNameGenerator::class,
    ...
    'db'         => [
         ...
         */
        'tenant-migrations-path'            => base_path('Modules/*/Database/Migrations/tenant'),
         ...
         */
        'tenant-seed-class'                 => \Database\Seeders\tenant\TenantSeeder::class,
